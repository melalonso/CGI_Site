...
int main() {
    ...
    cout << "<html>\n"
            ...
            "\t\t\t\t\t<input type=\"text\" maxlength='30' placeholder=\"Enter product\" name=\"product\" required>\n"
    ...
    if (!isUserLogged) {
        cout << "\t\t<div id='login'>\n"
                ...
                "\t\t\t\t\t<input type=\"text\" placeholder=\"Enter username\" name=\"username\" maxlength=\"30\" required>\n"
